...
const I18N = {
  zh: {
    ...
    eyebrow: "宋海燕团队",
    lede: "以地图形式定期更新全国各级法院涉人工智能案件，点击省份即可探索该地各级法院的案件信息及报道链接，同时提供年份、争议焦点及所涉的AI 技术等多维筛选。",
  ...
  en: {
    ...
    lede: "A regularly updated atlas of AI-related cases before Chinese courts at all levels. Click a province to explore the cases and source links from its courts at every level, with filters for year, key issues and the AI technology involved.",
