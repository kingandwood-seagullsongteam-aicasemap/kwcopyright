...
// ===================================================================
// 法院/城市名 中英对照（v6：全部用官方完整名）
// 命名规则：
//   · 直辖市：[市] + [区] + 人民法院（直辖市本身是省级，不再加省前缀）
//   · 各省：[省/自治区] + [市] + [区/县/中级] + 人民法院（普通法院全部带省前缀）
//   · 互联网法院 / 知识产权法院 / 铁路运输法院 / 最高法：用官方注册名（不强加省前缀）
// EN 模式：
//   · 中级法院：{City} Intermediate People's Court ({Province})
//   · 区法院（直辖市）：{District} District People's Court ({City})
//   · 区法院（各省）：{District} District People's Court, {City} ({Province})
//   · 县级市：{City} City People's Court ({Province})
//   · 县：{County} County People's Court ({Province})
//   · 特殊法院：官方英文名
// ===================================================================
const COURT_I18N = {
  // ---- 最高法 ----
  ...
  "江苏省扬州市中级人民法院": "Yangzhou Intermediate People's Court (Jiangsu)",
  "江苏省无锡市中级人民法院": "Wuxi Intermediate People's Court (Jiangsu)",

  // ---- 浙江 ----
  "杭州互联网法院": "Hangzhou Internet Court",
  "浙江省杭州市中级人民法院": "Hangzhou Intermediate People's Court (Zhejiang)",
  "浙江省杭州市滨江区人民法院": "Binjiang District People's Court, Hangzhou (Zhejiang)",
  ...
  // ---- 湖北 ----
  "湖北省武汉东湖新技术开发区人民法院": "Wuhan East-Lake High-Tech Zone People's Court (Hubei)",
  "湖北省大悟县人民法院": "Dawu County People's Court (Hubei)",

  // ---- 湖南 ----
  "湖南省长沙市中级人民法院": "Changsha Intermediate People's Court (Hunan)",

  // ---- 广东 ----
  "广州互联网法院": "Guangzhou Internet Court",
  "广东省广州市中级人民法院": "Guangzhou Intermediate People's Court (Guangdong)",
  "广东省深圳市南山区人民法院": "Nanshan District People's Court, Shenzhen (Guangdong)",

  // ---- 四川（成都拆为两个法院：原"成都待核实"按案件分配到铁路法院或中院） ----
  "成都互联网法庭": "Chengdu Internet Court Tribunal",
  "成都铁路运输第一法院": "Chengdu Railway Transport Court No. 1",
  "四川省成都市中级人民法院": "Chengdu Intermediate People's Court (Sichuan)",

  // ---- 内蒙古 ----
  "内蒙古自治区呼和浩特市新城区人民法院": "Xincheng District People's Court, Hohhot (Inner Mongolia)",

  // ---- 河北 ----
  "河北省秦皇岛市山海关区人民法院": "Shanhaiguan District People's Court, Qinhuangdao (Hebei)",

  // ---- 广西 ----
  "广西壮族自治区桂林市叠彩区人民法院": "Diecai District People's Court, Guilin (Guangxi)",

  // ---- 新疆 ----
  "新疆维吾尔自治区乌鲁木齐市天山区人民法院": "Tianshan District People's Court, Ürümqi (Xinjiang)"
};
