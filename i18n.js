...
// ===================================================================
// 地理大区分组 · Geographic Region Grouping
// 用于地图省份的分色显示
// ===================================================================
const REGION_OF_PROVINCE = {
  // 华北 North
  "北京市": "north", "天津市": "north", "河北省": "north",
  "山西省": "north", "内蒙古自治区": "north",
  // 东北 Northeast
  "辽宁省": "northeast", "吉林省": "northeast", "黑龙江省": "northeast",
  // 华东 East
  "上海市": "east", "江苏省": "east", "浙江省": "east",
  "安徽省": "east", "福建省": "east", "江西省": "east", "山东省": "east",
  // 华中 Central
  ...
  // 港澳台
  "台湾省": "outlying", "香港特别行政区": "outlying", "澳门特别行政区": "outlying",
  // 最高法（虚拟，地图上不渲染）
  "最高人民法院": "supreme"
};

// 大区颜色（与金杜金/暖灰/黑配色协调的低饱和大地色）
const REGION_COLORS = {
  "north":     "#C9A47A",  // 华北 · 金棕
  "northeast": "#7A8FA0",  // 东北 · 青石
  "east":      "#8FA478",  // 华东 · 沉绿
  "central":   "#9988A8",  // 华中 · 灰紫
  "south":     "#BC8772",  // 华南 · 赤陶
  "southwest": "#B59A6E",  // 西南 · 砂金
  "northwest": "#D2C49E",  // 西北 · 浅沙
  "outlying":  "#A09BB0"   // 港澳台 · 薰衣草
};
